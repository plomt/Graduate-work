...
class PinsForm(forms.Form):
    pin1_void1 = forms.FloatField(help_text="Enter radius for PIN1 void", initial=0.08)
    pin1_fuel = forms.FloatField(help_text="Enter radius for PIN1 fuel", initial=0.378)
    pin1_void2 = forms.FloatField(help_text="Enter radius for PIN1 void", initial=0.388)
    pin1_clad= forms.FloatField(help_text="Enter radius for PIN1 clad", initial=0.4575)

    pin2_termfuel = forms.FloatField(help_text="Enter radius for PIN2 termfuel", initial=0.44)
    pin2_clad = forms.FloatField(help_text="Enter radius for PIN2 clad", initial=0.515)
